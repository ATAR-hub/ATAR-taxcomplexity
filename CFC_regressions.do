...
*************************************************************************
***Online Appendix 5 - Panel A - CFC - EU-only Analysis of the Moderation of Country-Level Design Elements of Single Anti-Tax Avoidance Rules 
*************************************************************************
...
xtset country year
xtreg reg04_index_c CFCintro CountryCfcTresholdR c.CFCintro#c.MCountryCfcTresholdR vae pve gee rqe rle cce CountryTaxrate if CountryEu == 1, i(country)fe vce(cluster country) 


*************************************************************************
***Online Appendix 5 - Panel B - CFC - EU-only Analysis of the Moderation of Indicators for the Development of the Tax System of Countries 
*************************************************************************

*Regression for GDP pc
xtset country year
xtreg reg04_index_c CFCintro Gdppc c.CFCintro#c.MGdppc vae pve gee rqe rle cce CountryTaxrate if CountryEu == 1, i(country)fe vce(cluster country) 

*Regression for Full-Time Employees /Total Population
xtset country year
xtreg reg04_index_c CFCintro FTEpop c.CFCintro#c.MFTEpop vae pve gee rqe rle cce CountryTaxrate if CountryEu == 1, i(country)fe vce(cluster country) 

*Regression for Full-Time Employees with Master Degree or Higher Divided by Total Full-Time Employees
xtset country year
xtreg reg04_index_c CFCintro FTEmaster c.CFCintro#c.MFTEmaster vae pve gee rqe rle cce CountryTaxrate if CountryEu == 1, i(country)fe vce(cluster country) 

*Regression for Artificial Intelligence used/implementing?
xtset country year
xtreg reg04_index_c CFCintro AI c.CFCintro#c.MAI vae pve gee rqe rle cce CountryTaxrate if CountryEu == 1, i(country)fe vce(cluster country) 

*Regression for Cooperative Compliance in Place
xtset country year
xtreg reg04_index_c CFCintro CC c.CFCintro#c.MCC vae pve gee rqe rle cce CountryTaxrate if CountryEu == 1, i(country)fe vce(cluster country) 

*Regression for Robotic Process Automation
xtset country year
xtreg reg04_index_c CFCintro RPA c.CFCintro#c.MRPA vae pve gee rqe rle cce CountryTaxrate if CountryEu == 1, i(country)fe vce(cluster country) 

*Regression for Appeals
xtset country year
xtreg reg04_index_c CFCintro ap_index_c c.CFCintro#c.Map_index_c vae pve gee rqe rle cce CountryTaxrate if CountryEu == 1, i(country)fe vce(cluster country) 



*************************************************************************
***Online Appendix 5 - Panel C - CFC - EU-only Analysis of the Moderation of Tax Haven Classifications
*************************************************************************

*Regression Tax Havens Lips/Cobham (TJN)
xtset country year
xtreg reg04_index_c CFCintro CountryTaxhaventjn c.CFCintro#c.CountryTaxhaventjn vae pve gee rqe rle cce CountryTaxrate if CountryEu == 1, i(country)fe vce(cluster country) 

*Regression Tax Havens Dyreng
xtset country year
xtreg reg04_index_c CFCintro CountryTaxhavendyreng c.CFCintro#c.CountryTaxhavendyreng vae pve gee rqe rle cce CountryTaxrate if CountryEu == 1, i(country)fe vce(cluster country) 

*Regression Tax havens acc. to Torslov
xtset country year
xtreg reg04_index_c CFCintro CountryTaxhavenz c.CFCintro#c.CountryTaxhavenz vae pve gee rqe rle cce CountryTaxrate if CountryEu == 1, i(country)fe vce(cluster country) 

*Regression Conduit Tax Havens acc. to Garcia-Bernando
xtset country year
xtreg reg04_index_c CFCintro CountryTaxhavenconduit c.CFCintro#c.CountryTaxhavenconduit vae pve gee rqe rle cce CountryTaxrate if CountryEu == 1, i(country)fe vce(cluster country) 

*Regression Sink OFCs acc. to Garcia-Bernando
xtset country year
xtreg reg04_index_c CFCintro CountryTaxhavensink c.CFCintro#c.CountryTaxhavensink vae pve gee rqe rle cce CountryTaxrate if CountryEu == 1, i(country)fe vce(cluster country) 
