...
***IMPORTANT:GAAR always omitted, as no EU country introduced GAAR in time studied!
***********************************************************************************************************************************************************************************************


*************************************************************************
***Online Appendix 5 - Panel B- GAAR - EU-only Analysis of the Moderation of Indicators for the Development of the Tax System of Countries 
*************************************************************************

*Regression for GDP pc
xtset country year
xtreg reg08_index_c GAARintro Gdppc c.GAARintro#c.MGdppc vae pve gee rqe rle cce CountryTaxrate if CountryEu == 1, i(country)fe vce(cluster country) 

*Regression for Full-Time Employees /Total Population
xtset country year
xtreg reg08_index_c GAARintro FTEpop c.GAARintro#c.MFTEpop vae pve gee rqe rle cce CountryTaxrate if CountryEu == 1, i(country)fe vce(cluster country) 

*Regression for Full-Time Employees with Master Degree or Higher Divided by Total Full-Time Employees
xtset country year
xtreg reg08_index_c GAARintro FTEmaster c.GAARintro#c.MFTEmaster vae pve gee rqe rle cce CountryTaxrate if CountryEu == 1, i(country)fe vce(cluster country) 

*Regression for Artificial Intelligence used/implementing?
xtset country year
xtreg reg08_index_c GAARintro AI c.GAARintro#c.MAI vae pve gee rqe rle cce CountryTaxrate if CountryEu == 1, i(country)fe vce(cluster country) 

*Regression for Cooperative Compliance in Place
xtset country year
xtreg reg08_index_c GAARintro CC c.GAARintro#c.MCC vae pve gee rqe rle cce CountryTaxrate if CountryEu == 1, i(country)fe vce(cluster country) 

*Regression for Robotic Process Automation
xtset country year
xtreg reg08_index_c GAARintro RPA c.GAARintro#c.MRPA vae pve gee rqe rle cce CountryTaxrate if CountryEu == 1, i(country)fe vce(cluster country) 

*Regression for Appeals
xtset country year
xtreg reg08_index_c GAARintro ap_index_c c.GAARintro#c.Map_index_c vae pve gee rqe rle cce CountryTaxrate if CountryEu == 1, i(country)fe vce(cluster country) 



*************************************************************************
***Online Appendix 5 - Panel C - GAAR - EU-only Analysis of the Moderation of Tax Haven Classifications
*************************************************************************

*Regression Tax Havens Lips/Cobham (TJN)
xtset country year
xtreg reg08_index_c GAARintro CountryTaxhaventjn c.GAARintro#c.CountryTaxhaventjn vae pve gee rqe rle cce CountryTaxrate if CountryEu == 1, i(country)fe vce(cluster country) 

*Regression Tax Havens Dyreng
xtset country year
xtreg reg08_index_c GAARintro CountryTaxhavendyreng c.GAARintro#c.CountryTaxhavendyreng vae pve gee rqe rle cce CountryTaxrate if CountryEu == 1, i(country)fe vce(cluster country) 

*Regression Tax havens acc. to Torslov
xtset country year
xtreg reg08_index_c GAARintro CountryTaxhavenz c.GAARintro#c.CountryTaxhavenz vae pve gee rqe rle cce CountryTaxrate if CountryEu == 1, i(country)fe vce(cluster country) 

*Regression Conduit Tax Havens acc. to Garcia-Bernando
xtset country year
xtreg reg08_index_c GAARintro CountryTaxhavenconduit c.GAARintro#c.CountryTaxhavenconduit vae pve gee rqe rle cce CountryTaxrate if CountryEu == 1, i(country)fe vce(cluster country) 

*Regression Sink OFCs acc. to Garcia-Bernando
xtset country year
xtreg reg08_index_c GAARintro CountryTaxhavensink c.GAARintro#c.CountryTaxhavensink vae pve gee rqe rle cce CountryTaxrate if CountryEu == 1, i(country)fe vce(cluster country) 
